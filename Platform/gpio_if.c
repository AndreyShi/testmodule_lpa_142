...
//--------------------------------------------------
/*все четыре пина сконфигурированы как
плавающий вход (input floating), для задания адреса
запаивается резистор 2.9kOm, тем самым притягивая пин к земле,
т е задумывалось что input floating будет давать 1 всегда, а
пин с резистором 0, в итоге на ноге PD4 (ID_4) 
с неприпаянным резистором(input floating) дается 0, а не 1  
*/
