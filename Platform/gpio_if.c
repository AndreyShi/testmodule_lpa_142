...
плавающий вход (input floating), гдето
показывается 1 где-то 0
13.02.2025
нужна была внутренняя подтяжка и стало все ок input floating -> input pullUP
1 начинается    от 0.650 mV
0 заканчивается на 0.350 mV
*/
