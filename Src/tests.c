...
typedef struct _levels
{
    ...
    uint8_t t_in_er[2];       //правильный   выход и ошибка
    uint8_t f_in_er[2];       //неправильный выход и ошибка
    uint8_t u_in_er[2][2];    //нереальный   выход и ошибка (2 оставшиеся комбинации)

    char* sr;                 //ошибка в случае правильный/неправильный
    uint8_t sr_a;             //ошибка в случае правильный/неправильный (числовой эквивалент)

    char* sr_un    [4];       //ошибка в случае нереальный
    uint8_t sr_a_un[4];       //ошибка в случае нереальный (числовой эквивалент)
}lvls;
...
lvls lvs[] = {
              {0.1, {0,1}, {0,0}, {{1,1},{1,0}}, "Д\n", _e, ZIKL_s, ZIKL_i},  //точно обрыв
              {0.2, {0,0}, {0,1}, {{1,1},{1,0}}, "Д\n", _e, ZIKL_s, ZIKL_i},  //окно переключения на выкл
              {0.3, {0,0}, {0,1}, {{1,1},{1,0}}, "Д\n", _e, ZIKL_s, ZIKL_i},  //окно переключения на выкл
              {0.4, {0,0}, {0,1}, {{1,1},{1,0}}, "Д\n", _e, ZIKL_s, ZIKL_i},  //точно выкл

              {1.6, {0,0}, {1,0}, {{1,1},{0,1}}, "Е\n", _f, ZIKL_s, ZIKL_i},  //точно выкл
              {1.7, {1,0}, {0,0}, {{1,1},{0,1}}, "Е\n", _f, ZIKL_s, ZIKL_i},  //окно переключения на вкл
              {1.8, {1,0}, {0,0}, {{1,1},{0,1}}, "Е\n", _f, ZIKL_s, ZIKL_i},  //окно переключения на вкл
              {1.9, {1,0}, {0,0}, {{1,1},{0,1}}, "Е\n", _f, ZIKL_s, ZIKL_i},  //окно переключения на вкл
              {2.0, {1,0}, {0,0}, {{1,1},{0,1}}, "Е\n", _f, ZIKL_s, ZIKL_i},  //окно переключения на вкл
              {2.1, {1,0}, {0,0}, {{1,1},{0,1}}, "Е\n", _f, ZIKL_s, ZIKL_i},  //точно вкл

              {6.5, {1,0}, {1,1}, {{0,1},{0,0}}, "Ж\n", _g, ZIKL_s, ZIKL_i},  //точно вкл
              {6.6, {1,1}, {1,0}, {{0,1},{0,0}}, "Ж\n", _g, ZIKL_s, ZIKL_i},  //окно переключения на КЗ
              {6.7, {1,1}, {1,0}, {{0,1},{0,0}}, "Ж\n", _g, ZIKL_s, ZIKL_i},  //окно переключения на КЗ
              {6.8, {1,1}, {1,0}, {{0,1},{0,0}}, "Ж\n", _g, ZIKL_s, ZIKL_i},  //окно переключения на КЗ
              {6.9, {1,1}, {1,0}, {{0,1},{0,0}}, "Ж\n", _g, ZIKL_s, ZIKL_i},  //окно переключения на КЗ
              {7.0, {1,1}, {1,0}, {{0,1},{0,0}}, "Ж\n", _g, ZIKL_s, ZIKL_i},  //точно КЗ

              {1.6, {1,0}, {0,0}, {{1,1},{0,1}}, "Е\n", _f, ZIKL_s, ZIKL_i},  //точно вкл
              {1.5, {0,0}, {1,0}, {{1,1},{0,1}}, "Е\n", _f, ZIKL_s, ZIKL_i},  //окно переключения на выкл
              {1.4, {0,0}, {1,0}, {{1,1},{0,1}}, "Е\n", _f, ZIKL_s, ZIKL_i},  //окно переключения на выкл
              {1.3, {0,0}, {1,0}, {{1,1},{0,1}}, "Е\n", _f, ZIKL_s, ZIKL_i},  //окно переключения на выкл
              {1.2, {0,0}, {1,0}, {{1,1},{0,1}}, "Е\n", _f, ZIKL_s, ZIKL_i},  //точно выкл
             };
